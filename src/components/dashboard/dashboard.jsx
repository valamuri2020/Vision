...
export const Dashboard = ({...props}) => {
    ...
    const score = 40; 
    const information = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tincidunt dictum quam, sed pretium odio commodo et. Sed placerat id odio in congue. Quisque lacinia eget ex et fringilla. Suspendisse sit amet luctus diam. Integer congue'
